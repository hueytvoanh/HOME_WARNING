...
#define BACKDOOR_WARNING_LEVEL   HIGH
#define SLEEPDOOR_WARNING_LEVEL  HIGH
...
#define LED7_SYSTEM_RUNNING   25
#define LED7_SYSTEM_IDLE      26       
...
boolean pirState, frontDoorState, backDoorState, sleepDoorState;
int relayActive, relayTimer;
 ...
 switch(type){
  ...
  case LED7_ACQ_H:
    ...
    case LED7_GSM_SMS_ERROR:
       ...
       led_dot = 15; 
       break;
    case LED7_SYSTEM_RUNNING:
       led_100 = 1;
       led_10 = 1;
       led_1 = 1;
       led_dot = 1; 
       break;
    case LED7_SYSTEM_IDLE:
       led_100 = 11;
       led_10 = 11;
       led_1 = 11;
       led_dot = 11; 
...
void relayControl(int relayTimer){
    if(relayActive == true){
        digitalWrite(OUTPUT_RELAY, RELAY_ACTIVE); 
        if(relayTimer = 5){
             delay(5000);
